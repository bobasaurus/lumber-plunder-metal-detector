...
#define ADC1_IN1_RX_Pin GPIO_PIN_0
#define ADC1_IN1_RX_GPIO_Port GPIOA
...
#define DAC1_OUT1_TX_Pin GPIO_PIN_4
#define DAC1_OUT1_TX_GPIO_Port GPIOA
#define ADC2_IN2_BATV_Pin GPIO_PIN_5
#define ADC2_IN2_BATV_GPIO_Port GPIOA
#define DAC2_OUT1_AUDIO_Pin GPIO_PIN_6
#define DAC2_OUT1_AUDIO_GPIO_Port GPIOA
