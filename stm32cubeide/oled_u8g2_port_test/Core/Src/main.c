...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
    ...
    HAL_DAC_SetValue(&hdac1, DAC_CHANNEL_1, DAC_ALIGN_8B_R, 120);//1.55V

    HAL_DAC_Start(&hdac2, DAC_CHANNEL_1);
    HAL_DAC_SetValue(&hdac2, DAC_CHANNEL_1, DAC_ALIGN_8B_R, 200);//2.59V
